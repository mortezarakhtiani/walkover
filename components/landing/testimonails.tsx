...
const Testimonials = () => {
  ...
  <div className="flex w-[300px] shrink-0 flex-col rounded-xl border border-border/50 bg-background p-5 shadow-sm mx-1.5 transition-shadow duration-300 hover:shadow-md">
