...
<section className="mt-12">
    ...
    <Card>
        <CardContent className="p-0">
            ...
            <FAQItem
                question="چگونه سایز مناسب خودم را انتخاب کنم؟"
                answer="برای انتخاب سایز مناسب، بهتر است اندازه لباس فعلی خود را با جدول راهنمای سایز مقایسه کنید. در صورت وجود راهنمای سایز برای این محصول، اطلاعات آن از طریق گزینه «راهنمای سایز» قابل مشاهده خواهد بود."
            />

            <FAQItem
                question="سفارش چه زمانی ارسال می‌شود؟"
                answer="سفارش پس از ثبت و آماده‌سازی برای ارسال تحویل شرکت حمل‌ونقل می‌شود. زمان رسیدن سفارش به مقصد نیز با توجه به شهر و روش ارسال متفاوت است."
            />

            <FAQItem
                question="آیا محصول دقیقاً مطابق تصاویر است؟"
                answer="تلاش می‌شود تصاویر تا حد امکان نمایش‌دهنده ظاهر واقعی محصول باشند. با این حال ممکن است رنگ محصول به دلیل تنظیمات نمایشگر یا شرایط عکاسی کمی متفاوت دیده شود."
            />

            <FAQItem
                question="آیا امکان ثبت سفارش برای چند عدد وجود دارد؟"
                answer="بله. در صورتی که موجودی محصول کافی باشد، می‌توانید تعداد موردنظر خود را از طریق بخش تعداد انتخاب کرده و سپس محصول را به سبد خرید اضافه کنید."
            />
        </CardContent>
    </Card>
</section>
