  ...
  `,
    {
        variants: {
            ...
            permanent: {
                true: 'bg-input',
                false: 'data-[state=checked]:bg-blue-600',
            },
        },
        defaultVariants: {
            shape: 'pill',
...
const switchThumbVariants = cva(
    'pointer-events-none block bg-white w-1/2 h-[calc(100%-4px)] shadow-lg ring-0 transition-transform start-0 data-[state=unchecked]:translate-x-[2px] data-[state=checked]:translate-x-[calc(100%-2px)]',
    {
        variants: {
            shape: {
                pill: 'rounded-full',
